...
public class KattapaReadyForBattle {
	 ...
	 *
	 * @param int
	 *            size of the army, Integer[] number of weapons each soldier is
	 *            carrying
	 * @return String ready or not ready for battle based on Kattapa's luck
	 *         logic
	 */

	public String isReadyForBattle(int size, Integer[] soldierWeapons) {
		try {
			if (soldierWeapons.length != size) {
				return "Number of Soliders and weapons are not matching";
			}
