...
public class PrimeString {
	...
	/**
	 * Checks if the number of distinct alphabets and the number of occurrences
	 * of each alphabets is prime.
	 *
	 * @param Map<Character,
	 *            Integer> the map that is built from the input string
	 * @return true, if is Prime String
	 */

	private boolean isPrimeStringLogic(Map<Character, Integer> map) {
	...
	private Map<Character, Integer> buildMapFromString(String inputString) {
	...
	public String isPrimeString(String input) {
		try {
