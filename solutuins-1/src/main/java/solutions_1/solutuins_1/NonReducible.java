...
public class NonReducible {
	 ...
	 * @return The object ChopCount containing the trimmed string and number of operations
	 */
...
class ChopCount {
	...
	public boolean equals(Object o) {
		...
		if(cc.getNumberOfChops() == this.getNumberOfChops() && cc.getNonReducableStr().equals(this.getNonReducableStr())) {
			return true;
		}
		else {
			return false;
